...
public class JuegoFrame extends javax.swing.JFrame {
    ...
    public JuegoFrame() {
        ...
        if(DificultadFrame.comboBoxDificultad.getSelectedItem().toString().equals("Fácil")){
            this.setLocation(520, 200);
        }   
        if(DificultadFrame.comboBoxDificultad.getSelectedItem().toString().equals("Media")){
            this.setLocation(490, 160);
        }  
        if(DificultadFrame.comboBoxDificultad.getSelectedItem().toString().equals("Difícil")){
            this.setLocation(440, 60);
        }  
        if(DificultadFrame.comboBoxDificultad.getSelectedItem().toString().equals("Personalizada")){
            this.setLocationRelativeTo(null);
        }  
        this.setResizable(false);
        
        this.setSize(( DificultadFrame.filas * 25) + 20, ( DificultadFrame.columnas * 25) + 115);
    ...
    private void initComponents() {
        ...
        jPanel4.setLayout(new java.awt.GridLayout(DificultadFrame.filas, DificultadFrame.filas));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < DificultadFrame.filas; i++) {
            for (int j = 0; j < DificultadFrame.columnas; j++) {
    ...
    private void crearTablero(){
        textFieldMinasContador.setText(Integer.toString(DificultadFrame.minas));
        this.casillas = new Casilla[DificultadFrame.filas][DificultadFrame.columnas];
        this.casillasMinadas = new boolean[DificultadFrame.filas][DificultadFrame.columnas];
        ...
        jPanel4.removeAll();
        jPanel4.updateUI();
        this.casillasMinadas = determinarCasillasMinadas(DificultadFrame.minas);
    ...
    private boolean[][] determinarCasillasMinadas(int minas){       
        int cont = 0;                  
        boolean auxMatriz[][] = new boolean[DificultadFrame.filas][DificultadFrame.columnas];
        ...
        while(cont < minas){
            ...
            for (int i = 0; i < DificultadFrame.filas; i++) {
                ...
                if(bandera == true){
                        break;}             
                for (int j = 0; j < DificultadFrame.filas; j++) {
