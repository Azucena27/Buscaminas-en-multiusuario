...
public class DificultadFrame extends javax.swing.JFrame {
    public static int filas, columnas, minas;

    public DificultadFrame() {
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("images/mine.png")).getImage());
        this.setTitle("Buscaminas  " + "  ||    Bienvenido " + IngresoFrame.jugador.getUsername());
                ...
                try
                {
                    if( textFieldFilas.getText().trim().equals("") || textFieldColumnas.getText().trim().equals("") || textFieldMinas.getText().trim().equals("") ){
                        ...
                        if(filas != columnas){
                            ...
                            JuegoFrame frameJuego = new JuegoFrame();
